...
import (
	...
	"github.com/vnpaycloud-console/gophercloud/v2/openstack/blockstorage/v3/attachments"
	v3 "github.com/vnpaycloud-console/gophercloud/v2/openstack/blockstorage/v3/volumes"
