...
[here](https://github.com/vnpaycloud-console/gophercloud/tree/main/docs/contributor-tutorial)!
...
[bug tracker](https://github.com/vnpaycloud-console/gophercloud/issues) and finding open
...
and can be read online at [godoc.org](https://godoc.org/github.com/vnpaycloud-console/gophercloud).
...
get dependencies for unit and acceptance tests.
   ...
   ```bash
   go get -tags "fixtures acceptance" github.com/vnpaycloud-console/gophercloud
   ```

2. Move into the directory that houses your local repository:

   ```bash
   cd ${GOPATH}/src/github.com/vnpaycloud-console/gophercloud
   ```

3. Fork the `vnpaycloud-console/gophercloud` repository and update your remote refs. You
...
7. Submit your branch as a [Pull Request](https://help.github.com/articles/creating-a-pull-request/). When submitting a Pull Request, please follow our [Style Guide](https://github.com/vnpaycloud-console/gophercloud/blob/main/docs/STYLEGUIDE.md).
...
import (
  ...
  "github.com/vnpaycloud-console/gophercloud/testhelper"
)
...
import (
	...
	th "github.com/vnpaycloud-console/gophercloud/testhelper"
	fake "github.com/vnpaycloud-console/gophercloud/testhelper/client"
	"github.com/vnpaycloud-console/gophercloud/openstack/networking/v2/networks"
)
