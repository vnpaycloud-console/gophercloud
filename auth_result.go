...
The following types satisfy this interface:
	...
	github.com/vnpaycloud-console/gophercloud/openstack/identity/v2/tokens.CreateResult
	github.com/vnpaycloud-console/gophercloud/openstack/identity/v3/tokens.CreateResult
